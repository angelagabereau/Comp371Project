...
void Wall::drawCube()
{
	...
	glBegin(GL_QUADS);
		...
		glTexCoord2f(0.0f, 0.0f); glVertex3f(-1.00f, -1.00f,  1.00f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f( 1.00f, -1.00f,  1.00f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1.00f,  1.00f,  1.00f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(-1.00f,  1.00f,  1.00f);
		// Back Face
		glNormal3f(0.0,0.0,-1.0);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(-1.00f, -1.00f, -1.00f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(-1.00f,  1.00f, -1.00f);
